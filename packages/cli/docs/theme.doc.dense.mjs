...
export const docsDense = {
  ...
  sections: [
    ...
    { title: 'Component Overrides', content: [{ type: 'prose', text: 'components field targets .xds-* classes. write standard CSS (borderRadius, padding) — pipeline expands to internal vars. public vars (--button-press-scale etc) set directly. private vars (--_*) cannot be set — use CSS properties. run `npx xds component <Name>` for details.' }, null, null, null, null] },
    { title: 'Custom Variants', content: [{ type: 'prose', text: 'any unknown prop:value in components becomes a new variant. xds theme build generates TS augmentations. works on any extensible prop axis (variant, status, etc).' }, null, null, null, null] },
